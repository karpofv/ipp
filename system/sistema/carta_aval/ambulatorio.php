<?php
    ...
    foreach($consultit as $tit){
        ...
        $consullimite = paraTodos::arrayConsultanum("cobl_monto", "cobertura_limite", "cobl_caso=3 and cobl_tipo_emp=$tit[titp_tippersonal] and cobl_vicerrectorado=$tit[titp_viccodigo] and (cobl_solicita=1 or cobl_solicita=0)");        
        if($consullimite>0){
            $consullimite = paraTodos::arrayConsulta("cobl_monto", "cobertura_limite", "cobl_caso=3 and cobl_tipo_emp=$tit[titp_tippersonal] and cobl_vicerrectorado=$tit[titp_viccodigo] and (cobl_solicita=1 or   cobl_solicita=0)");        
        } else {
            /*Se busca limite en donde el parametro especifico el tipo de personal*/        
            $consullimite = paraTodos::arrayConsultanum("cobl_monto", "cobertura_limite", "cobl_caso=3 and cobl_tipo_emp=$tit[titp_tippersonal] and cobl_vicerrectorado=0 and (cobl_solicita=1 or cobl_solicita=0)");
            if($consullimite>0){
                $consullimite = paraTodos::arrayConsulta("cobl_monto", "cobertura_limite", "cobl_caso=3 and cobl_tipo_emp=$tit[titp_tippersonal] and cobl_vicerrectorado=0 and (cobl_solicita=1 or cobl_solicita=0)");
            } else {
                /*Se busca limite en donde el parametro especifico el vicerrectorado*/        
                $consullimite = paraTodos::arrayConsultanum("cobl_monto", "cobertura_limite", "cobl_caso=3 and cobl_tipo_emp=0 and cobl_vicerrectorado=$tit[titp_viccodigo] and (cobl_solicita=1 or cobl_solicita=0)");
                if($consullimite>0){
                    $consullimite = paraTodos::arrayConsulta("cobl_monto", "cobertura_limite", "cobl_caso=3 and cobl_tipo_emp=0 and cobl_vicerrectorado=$tit[titp_viccodigo] and (cobl_solicita=1 or cobl_solicita=0)");
                } else {
                    /*Se busca limite con todos los parametros*/
                    $consullimite = paraTodos::arrayConsultanum("cobl_monto", "cobertura_limite", "cobl_caso=3 and cobl_tipo_emp=0 and cobl_vicerrectorado=0 and (cobl_solicita=1 or cobl_solicita=0)");
                    if($consullimite>0){
                        $consullimite = paraTodos::arrayConsulta("cobl_monto", "cobertura_limite", "cobl_caso=3 and cobl_tipo_emp=0 and cobl_vicerrectorado=0 and (cobl_solicita=1 or cobl_solicita=0)");
                    };
                }
            }
        }
        ...
        $consulcasos = paraTodos::arrayConsulta("sum(c.caso_indem) as total", "casos c", "c.caso_titcodigo=$codtit and c.caso_tipo=3 and c.caso_bencodigo='' and caso_status<>6");
