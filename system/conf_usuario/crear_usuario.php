        ...
        <div class="col-sm-12">
                ...
                <form class="form-horizontal" method="post" action="javascript:void(0)"
                    ...
                    <div class="col-sm-4" style="display: block;">
                        ...
                        <select class="form-control" id="seltipo">
                            <?php
                                combos::CombosSelect("1", "$tipo", "CodPerfil, Nombre", "perfiles", "CodPerfil", "Nombre", "CodPerfil<>4");
                                ?>
                        </select>
                    </div>
            ...
            <div class="with_background with_padding bottommargin_30">
                <table class="table table-hover" id="usuarios">
                    ...
                    <tbody>
                        <?php
                        $consulta = paraTodos::arrayConsulta("u.id, u.Cedula, r.Nombres, r.Apellidos,u.Usuario, p.Nombre", "usuarios u, registrados r, perfiles p", "u.Cedula=r.cedula and u.Nivel=p.CodPerfil and  u.Nivel<>4");
                        foreach($consulta as $row){
                        ?>
                            <tr>
